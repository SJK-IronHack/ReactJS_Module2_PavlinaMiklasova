...
const Dropzone = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Dropzone_context.DropzoneProvider, { value: { accept: isDragAccept, reject: isDragReject, idle: isIdle } }, /* @__PURE__ */ React.createElement(
    core.Box,
    {
      ...getRootProps({ ref }),
