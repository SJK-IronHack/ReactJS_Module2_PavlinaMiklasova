...
const Avatar = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ...getStyles("root"), mod: { "within-group": ctx.withinGroup }, ref, ...others }, error ? /* @__PURE__ */ React.createElement("span", { ...getStyles("placeholder"), title: alt }, children || /* @__PURE__ */ React.createElement(AvatarPlaceholderIcon, null)) : /* @__PURE__ */ React.createElement(
    "img",
    {
      ...imageProps,
      ...getStyles("image"),
